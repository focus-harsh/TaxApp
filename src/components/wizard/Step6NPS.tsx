...
export default function Step6NPS() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-slate-900 mb-2">National Pension System (NPS)</h2>
        <p className="text-slate-500 mb-4">Extra tax savings over and above the ₹1.5L limit of 80C.</p>
      </div>

      <div className="space-y-6">
        <div className="p-4 border border-slate-200 rounded-2xl bg-white hover:border-blue-200 transition-colors">
          <div className="mb-4">
            <p className="font-semibold text-slate-800">Voluntary Contribution [80CCD(1B)]</p>
            <p className="text-sm text-slate-500">Max ₹50,000 allowed in Old Regime.</p>
          </div>
        ...
        <div className="p-4 border border-slate-200 rounded-2xl bg-white hover:border-blue-200 transition-colors">
          <div className="mb-4">
            <p className="font-semibold text-slate-800">Employer Contribution [80CCD(2)]</p>
            <p className="text-sm text-slate-500">Allowed in BOTH Old and New Regimes! Up to 10% (14% for Govt) of Basic + DA.</p>
          </div>
          <div className="relative w-full">
            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              <span className="text-slate-500 text-lg font-medium">₹</span>
