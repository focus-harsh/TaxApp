...
export default function Step3Deductions() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Your Provident Fund (EPF/VPF)</h2>
        <p className="text-slate-500 dark:text-slate-400 mb-6">Enter your annual employee contribution. This is usually deducted from your salary.</p>
      ...
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Professional Tax</h2>
        <p className="text-slate-500 dark:text-slate-400 mb-6">Enter your annual professional tax deducted by your employer (Max ₹2,500).</p>
