...
export default function Step580C() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-slate-900 mb-2">Section 80C Investments</h2>
        <p className="text-slate-500 mb-4">Max deduction allowed is ₹1.5 Lakhs in the Old Regime. Note: EPF from Step 3 is already included.</p>
        <div className="bg-blue-50 text-blue-700 font-semibold px-4 py-3 rounded-lg border border-blue-100 mb-6">
